...
curl -o /tmp/ProfitTrailer/unzip/BOOT-INF/classes/static/js/ProfitTrailer_GUI_extensions_v1.1.user.js https://github.com/darrenchwu/ProfitTrailer/raw/master/ProfitTrailer_GUI_extensions_v1.1.user.js
